...
export const CAMINO_NODES = [
  { level: 'N0', name: 'Fundamentos matemáticos', outcome: 'Ajusta tu primera recta por mínimos cuadrados', meta: '5 demos · 17 ejercicios', path: '/modulos/fundamentos', color: '#22D3EE' },
  { level: 'N1', name: 'ML clásico', outcome: 'Clasifica, mide y regulariza como un profesional', meta: '7 demos · 10 ejercicios', path: '/modulos/ml-clasico', color: '#22D3EE' },
  { level: 'N2', name: 'Redes neuronales', outcome: 'Implementa backpropagation desde cero', meta: '6 demos · 9 ejercicios', path: '/modulos/redes-neuronales', color: '#8B5CF6' },
  { level: 'N3', name: 'CNN', outcome: 'Extrae features de imágenes con tus propios kernels', meta: '6 demos · 10 ejercicios', path: '/modulos/cnn', color: '#8B5CF6' },
  { level: 'N4', name: 'Secuencias', outcome: 'Entrena una LSTM que predice texto', meta: '5 demos · 9 ejercicios', path: '/modulos/secuencias', color: '#8B5CF6' },
  { level: 'N5', name: 'Transformers', outcome: 'Programa self-attention multi-cabeza a mano', meta: '6 demos · 9 ejercicios', path: '/modulos/transformers', color: '#FBBF24' },
